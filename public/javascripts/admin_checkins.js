$(document).ready(function() {
  new Highcharts.Chart({
    ...
    series: [{name: 'Non-Member Checkins', pointInterval: 24 * 3600 * 1000, pointStart: dstart, data: non_checkins},
             ...
             {name: 'Guy Member Checkins', pointInterval: 24 * 3600 * 1000, pointStart: dstart, data: guy_checkins},
             {name: 'Gal Member Checkins', pointInterval: 24 * 3600 * 1000, pointStart: dstart, data: gal_checkins},
