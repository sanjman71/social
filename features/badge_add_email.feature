Feature: Emails are sent when a social dna badge is added to a user
  ...
  Scenario:
    ...
    Then "chicago_guy@outlately.com" should receive an email with subject "Outlately: Your Social DNA includes a new badge..."

    And I open the email with subject "Outlately: Your Social DNA includes a new badge..."
