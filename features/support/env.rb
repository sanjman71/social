...
# SK: this require causes 'undefined local variable or method node' errors
...
# Set default javascript driver
Capybara.javascript_driver = :selenium # default driver when using @javascript tag
